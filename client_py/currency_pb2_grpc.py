...
class CurrencyServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetRate = channel.unary_unary(
                ...
                response_deserializer=currency__pb2.RateResponse.FromString,
...
def add_CurrencyServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetRate': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=currency__pb2.RateResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'currency.CurrencyService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('currency.CurrencyService', rpc_method_handlers)
...
class CurrencyService(object):
    ...
    def GetRate(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            currency__pb2.RateResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
